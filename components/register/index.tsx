import { checkEmailAsync, createUser } from "@/axios/api";
  ...
  return (
    <View className='flex-1'>
      ...
      <View className='absolute h-full w-full'>
            ...
            <View className='bg-white relative h-full rounded-t-xl'>
              <View className='px-4 py-3'>
                ...
                <Text className='text-center text-secondary font-lexend pt-2 pb-16'>
                  Tạo hồ sơ , follow các tài khoản khác, quay video của chính
                  bạn, v.v.
                </Text>
                <View>
              ...
              <View className='px-4 flex-row justify-center py-5 z-10 border-t-[1px] border-[#ededed] absolute left-0 right-0 bottom-0 bg-[#f7f7f9]'>
        ...
        {stepRegister === 2 && (
          <View className='bg-[#fff] flex-1 px-5 relative'>
            <View className='flex-1 absolute top-0 right-0 left-0 bottom-0 items-center'>
              <LottieView
                source={require("../../assets/loadings/birthday.json")} // File JSON của animation
                autoPlay
                loop
            ...
            <View className='flex-row items-center py-1'>
              ...
              >
                Yêu cầu người dùng phải từ 15 tuổi đổ lên
              </Text>
            </View>
